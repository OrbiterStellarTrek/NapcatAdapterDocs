...
在 ICQQ 公共签名服务遭受到不可抗力量干扰而被迫关闭的背景下，开发者意识到，“签名”若不握在自己手上，随时都会被一键拉闸。因此，开发者这排除了Lgr，又因LiteLoader几乎完全无法使用而排除llonebot，而 NapCatQQ 以其出色的易用性和便捷的部署方式进入了开发者视野。其开放的 API 设计降低了开发门槛，吸引了大量开发者尝试使用，并催生了许多针对 NapCatQQ 的适配器项目。
